          ...
          {(['all', ...statusOptions] as const).map((s) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs font-medium capitalize cursor-pointer transition-colors ${
                filter === s ? 'bg-[#FF6B35] text-white' : 'bg-white text-gray-500 border border-gray-200 hover:border-gray-300'
              }`}
            >
              {s}
            </button>
              ...
              submissions.map((s) => (
                <button
                  ...
                  className={`w-full text-left bg-white rounded-2xl border p-4 cursor-pointer transition-all hover:shadow-sm ${
                    selected?.id === s.id ? 'border-orange-300 ring-1 ring-orange-200' : 'border-gray-100'
                  }`}
                >
                  <div className="flex items-start justify-between gap-3 mb-1">
              ...
              {composing ? (
                ...
                <div className="p-5">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 w-full mb-4 px-4 py-2.5 bg-[#FF6B35] hover:bg-[#e55a27] text-white text-xs font-semibold rounded-xl transition-colors cursor-pointer"
                  >
