      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            { label: 'Blocked', value: totalBlocked, icon: 'ri-forbid-line', color: 'text-orange-500', bg: 'bg-orange-50', border: 'border-orange-100' },
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="relative flex-1 min-w-[180px]">
            ...
            <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search tasks or projects..."
              className="w-full pl-8 pr-3 py-2 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#FF6B35]/30 focus:border-[#FF6B35]" />
          </div>
                  ...
                  <div className="px-5 py-3.5 border-b border-gray-50 flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2.5 min-w-0">
                      <div className={`w-2.5 h-2.5 rounded-full flex-shrink-0 ${
                        group.type === 'retainer' ? 'bg-violet-400' :
