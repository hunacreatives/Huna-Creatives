...
export const projectDataMap: Record<string, ProjectData> = {
  ...
  'cooperative-plumbing-drain': {
    slug: 'cooperative-plumbing-drain',
    category: 'branding',
    categoryLabel: 'Branding & Identity',
    title: 'Cooperative Plumbing & Drain',
    subtitle:
      'A full brand strategy and identity system for the first employee-owned plumbing and drain company in its market — monogram, logo suite, color system, typography, and a written brand platform built around a single idea: ownership elevates everyone.',
    tags: [
      'Brand Strategy',
      'Logo Design',
      'Monogram Design',
    ...
    client: 'Cooperative Plumbing & Drain',
    timeline: '6 Weeks',
    industry: 'Home Services & Skilled Trades',
    scope: 'Brand Strategy, Identity & Applications',
    heroImage: '/images/coop-app-polo-front.webp',
    challenge: {
      heading: 'Making an ownership model visible',
      body:
        'Cooperative Plumbing & Drain is not structured like its competitors — every technician holds a stake in the business. But an ownership model is invisible on a service van. The challenge was building an identity that signalled accountability and craftsmanship without leaning on the tired visual language of the trades: no cartoon mascots, no loud novelty, no stock wrench icons. The brand had to look established enough for commercial property managers and warm enough for a homeowner with a burst pipe at midnight.',
    },
    approach: {
      heading: 'Restraint as a signal of craft',
      body:
        'We built the monogram from abstract water ripples and curved pipeline forms — a mark that reads as "COOP" or "CPD" depending on how you trace it, and as an eye at its centre, standing in for the employee-owned, customer-focused values at the heart of the business. The palette stays deliberately narrow: near-black and two depths of navy against a soft off-white, with a gradient reserved for hero moments. Copperplate Gothic sets headlines for its engraved, civic authority; Open Sans carries body copy. Underneath the visual work sits a full brand platform — purpose, positioning, personality, archetypes, and a customer promise — so the team has language to match the mark.',
    },
    logos: [
      {
        image: '/images/coop-logo-horizontal.webp',
        label: 'Primary Horizontal Lockup',
        bg: 'bg-white',
        noInvert: true,
      },
      {
        image: '/images/coop-logo-vertical.webp',
        label: 'Vertical Lockup',
        bg: 'bg-[#f4f4f4]',
        noInvert: true,
      },
      {
        image: '/images/coop-logo-monogram.webp',
        label: 'Monogram',
        bg: 'bg-[#e8ecf3]',
        noInvert: true,
      },
    ...
    typography: {
      description:
        'Copperplate Gothic gives headlines an engraved, civic weight — the typographic equivalent of a name cut into a building. Open Sans handles everything that has to be read quickly: service descriptions, estimates, dispatch notes, and web copy. The pairing keeps the brand formal at the top and plainspoken everywhere else.',
      fonts: [
        {
          role: 'Headlines / Display',
          family: 'Copperplate Gothic BT',
          weights: 'Regular',
          sample: 'OWNERSHIP ELEVATES EVERYONE.',
        },
        {
          role: 'Body / Interface',
          family: 'Open Sans',
          ...
          sample:
            'For homeowners, businesses, and property managers seeking dependable plumbing solutions — every technician has a personal stake in delivering exceptional craftsmanship, honest recommendations, and lasting value.',
        },
      ],
    },
    colors: [
      { name: 'Off White', hex: '#f4f4f4' },
      { name: 'Near Black', hex: '#212121' },
      { name: 'Deep Navy', hex: '#030923' },
      { name: 'Signal Navy', hex: '#041a53' },
    ],
    applications: [
      {
        image: '/images/coop-app-toolbox.webp',
        label: 'Branded Equipment Case',
      },
      {
        image: '/images/coop-app-van-front.webp',
        label: 'Service Vehicle Wrap',
      },
      {
        image: '/images/coop-app-van-rear.webp',
        label: 'Vehicle Wrap — Rear & Side',
      },
      {
        image: '/images/coop-app-polo-front.webp',
        label: 'Uniform — Embroidered Monogram',
      },
      {
        image: '/images/coop-app-polo-back.webp',
        label: 'Uniform — Full Lockup',
      },
      {
        image: '/images/coop-mood.webp',
        label: 'Brand Imagery Direction',
      },
    ],
    results: {
      summary:
        'Cooperative Plumbing & Drain launched with a complete brand platform — a distinctive monogram, a full logo suite, a disciplined color and type system, and the written strategy that explains why every piece of it exists.',
      metrics: [
        {
          value: '3',
          label: 'Logo Lockups',
          detail: 'Horizontal, vertical, and standalone monogram',
        },
        {
          value: '11',
          label: 'Pages of Brand Strategy',
          detail: 'Purpose, positioning, personality & voice',
        },
        {
          value: '100%',
          label: 'Brand Satisfaction',
          detail: 'Approved through to final brand board',
        },
      ],
    },
  },
