        ...
        >
          <div className="flex flex-col gap-5 rounded-2xl p-6" style={{ background: '#111111' }}>
            ...
            <button
              ...
              className="text-sm font-medium tracking-wide text-gray-200 hover:text-orange-400 whitespace-nowrap cursor-pointer font-body text-left flex items-center gap-2"
              style={{ transition: 'color 180ms ease' }}
            >
